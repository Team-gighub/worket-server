...
public class KakaoOauthService {
  ...
  public ApiResponse<String> logout(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      return ApiResponse.error(e.getMessage(), "INVALID_REQUEST");

    } catch (RestClientException e) {
      return ApiResponse.error("카카오 서버와 통신 중 오류가 발생했습니다.", "KAKAO_API_ERROR");

    } catch (Exception e) {
      return ApiResponse.error("로그아웃 중 오류가 발생했습니다.", "LOGOUT_ERROR");
    }
  }
  ...
  public ApiResponse<String> unlink(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      // 3. 내부 RefreshToken 폐기
      refreshTokenService.revokeAllRefreshTokens(userId);

      // 4. 사용자 상태 DELETED로 변경
      ...
      return ApiResponse.error("연동 해제 중 오류가 발생했습니다.", "UNLINK_ERROR");
    }
  }
  ...
  private void callKakaoApi(String url, String kakaoAccessToken) {
    ...
    try {
      ...
      throw e; // 상위에서 ApiResponse.error로 전환
    }
  }
}
